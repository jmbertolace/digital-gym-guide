...
import { carregarEstado, useEstado } from "../lib/store";
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Esta tela não existe ou foi movida.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "JB Training Pro" },
...
function TemaEfeito() {
  ...
  useEffect(() => {
    document.documentElement.classList.toggle("tema-claro", config.tema === "claro");
  }, [config.tema]);
  return null;
}
